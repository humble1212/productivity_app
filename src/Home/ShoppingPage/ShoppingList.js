      ...
      <div className=" w-80 h-full p-2 border rounded flex-col">
        ...
        <div className=" w-full h-3/5">
          <div className=" w-full h-full footer--shadow flex-col flex items-start py-6 justify-start border-b relative">
            ...
            <div className="activeElement hover:bg-teal-950 hover:border-none hover:text-white border rounded-full border-orange-300 absolute bottom-1 left-1 right-1 h-12 flex items-center justify-center p-2 font-bold text-gray-600 cursor-pointer">
              <NavLink to={"../ShoppingInput/"}>Create New +</NavLink>
            </div>
          </div>
        </div>
      </div>
          ...
          {/* {sortedTasks.map((value) => {
            return (
              <li
                ...
                <header className="w-full flex flex-col items-start justify-center gap-3 p-2">
                  ...
                  <div className=" w-full flex items-center justify-between p-2 h-auto border-b border-orange-300">
                    <div className="flex-1 flex items-center justify-start gap-4">
                      <span className=" flex items-center justify-start w-max p-2 border shadow-lg rounded-lg text-orange-400 font-semibold">
                        From:
                        {`${
                ...
                <div className=" w-full max-h-mpHgt bg-gray-600 overflow-auto text-white p-1">
                  {value.detailsList.map((Data) => {
                    return (
                      <div
                        className="flex w-full border border-gray-500 items-center p-2 rounded gap-2 my-4"
                        key={Data.id}>
                        ...
                        <span className="flex-1 flex items-center justify-start gap-2">
                          <strong
                            className="bg-orange-500 text-white text-sm p-1 text-left overflow-hidden truncate"
                            style={{
                              width: `${
